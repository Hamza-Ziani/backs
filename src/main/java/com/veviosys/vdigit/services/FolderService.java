...
public class FolderService {
    ...
    public Page<Folder> getLastWeekFolders(Pageable pageable) {
        return folderRepository.findAll(new Specification<Folder>() {
            ...
            public Predicate toPredicate(Root<Folder> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
             ...
             /*   predicates.add(criteriaBuilder.lessThanOrEqualTo(criteriaBuilder.function(datedif, Integer.class,
				...
				c.add(Calendar.DATE,-1);
				  Calendar c1 = Calendar.getInstance();
					...
					p = criteriaBuilder.and(p, criteriaBuilder.between(root.get("creation_date"),c.getTime(),c1.getTime()));
                ...
                p = criteriaBuilder.and(p, criteriaBuilder.equal(root.get("type").get("premierNiveau"), 1));
                return p;
            }
        }, pageable);
    }
        ...
        return folderRepository.findAll(new Specification<Folder>() {
            ...
            public Predicate toPredicate(Root<Folder> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
             ...
             //   List<Predicate> predicates = new ArrayList<>();
              /*  predicates.add(criteriaBuilder.greaterThanOrEqualTo(criteriaBuilder.function(datedif, Integer.class,
				...
				c.add(Calendar.DATE,-3);
				  Calendar c1 = Calendar.getInstance();
					c1.setTime(d); 
					c1.add(Calendar.DATE,-1);
              //  predicates.add(criteriaBuilder.between(root.get("creation_date"),c.getTime(),c1.getTime()));
					  p = criteriaBuilder.and(p,criteriaBuilder.between(root.get("creation_date"),c.getTime(),c1.getTime()));
                User user = connectedUser();
                p = criteriaBuilder.and(p,criteriaBuilder.equal(root.get("type").get("premierNiveau"), 1));
    ...
    public Page<Folder> getFolderChilds(UUID parentFolderId, Pageable pageable,String secondary) {
